...
class DataCore(DataModel, DataTemplate, BaseData):
    """
    ...
    def __call__(self, mods_path, **kwargs):
        ...
        :raise PCDDataCoreIsNotUnique: If you already called data_core before.
        """
        #===========================================================================================
        ...
        for current_instance in self.get_all_model_instances():
